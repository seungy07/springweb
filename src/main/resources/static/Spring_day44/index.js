...
async function getPosts() {
    try {
        const res = await axios.get(' https://category-internet-version-treasury.trycloudflare.com/api/board');
...
async function writePost() {
    ...
    try {
        await axios.post(' https://category-internet-version-treasury.trycloudflare.com/api/board', payload);
...
async function removePost(id) {
    ...
    try {
        await axios.delete(' https://category-internet-version-treasury.trycloudflare.com/api/board', {
            params: { id, password }
        });
        await getPosts();
    } catch (err) {
...
async function addComment(boardId, btn) {
    ...
    try {
        await axios.post(' https://category-internet-version-treasury.trycloudflare.com/api/board/comments', payload);
        openCommentSet.add(boardId);
        await getPosts();
    } catch (err) {
        console.error(err);
...
async function removeComment(boardId, commentId) {
    const password = prompt('비밀번호를 입력하세요:');
    try {
        await axios.delete(' https://category-internet-version-treasury.trycloudflare.com/api/board/comments', {
